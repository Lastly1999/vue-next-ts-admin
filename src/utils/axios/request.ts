...
import {message} from 'ant-design-vue';  // 引入的antd的组件库

/**
 * 初始化new Interceptors().getInterceptors()
 * @param axios 拦截器封装类
 */
export class Interceptors {
    public instance: any;

    // 构造方法 创建类时初始化instance为axios的实例
    constructor() {
        // 创建axios实例
        this.instance = axios.create(
            {timeout: 1000 * 12, baseURL: process.env.VUE_APP_URL});
        // 初始化拦截器
